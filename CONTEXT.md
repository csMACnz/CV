...
- **Experience Route**: The canonical Experience route segment `/experience`, used in the debug-only local CMS API endpoint `/experience` for local Aspire data access.
